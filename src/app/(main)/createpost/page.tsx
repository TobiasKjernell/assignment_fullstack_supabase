...
const errorMessages = ['Post title already taken..']
const CreatePost = () => {
    ...
    return (
        <form onSubmit={handleSubmit(values => {
            ...
            <fieldset>
                ...
                <textarea className="w-full h-100 border border-gray-500 indent-2" id="content" {...register('content')} placeholder="Crickets in here..." />
            </fieldset>
